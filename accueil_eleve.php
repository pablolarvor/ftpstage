					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<table>
							...
							<tbody>
                                                            ...
                                                            <?php
                                                            // on crée la requête SQL 
                                                            $sql = 'SELECT * FROM stage, entreprise, etablissement WHERE stage.login_realisateur = "' . $_SESSION["login"] .'" AND stage.id_etab = etablissement.id_etab AND etablissement.id_ent = entreprise.id_ent'; 
                                                            ...
                                                            while ($donnees = mysql_fetch_array($req)){
                                                               echo('
                                                                <tr>
									<td><a href="visualiser_stage.php?id_stage=' . $donnees["id_stage"] . '">' . $donnees["theme"] . '</a></td>
									...
									<td>
										<!-- Icons -->
										 <a href="modifier_stage.php?id_stage=' . $donnees["id_stage"] . '" title="Modifier"><img src="resources/images/icons/pencil.png" alt="Edit" /></a>
										 <a href="accueil_eleve.php?deleteid=' . $donnees["id_stage"] . '" title="Supprimer" onclick="javascript:return confirm(\'Etes vous sûr de vouloir supprimer le stage ?\')"><img src="resources/images/icons/cross.png" alt="Delete"/></a>
									</td>
								</tr>');
                                                            }
						...
						<form id="myform" action="enregistrement_stage_eleve.php" method="post">
								...
								<p>
									...
									<label for="mail_contact">Adresse e-mail du contact</label>
										...
										<br /><small>Au format exemple@exemple.com</small>
                                                                ...
                                                                <p>
									<label for="resume">Résumé de votre stage</label>
								...
								<p>
									...
									<select name="statut" id="statut" class="small-input">
										<option value="vide">Choisissez un statut</option>
