		...
		<div id="main-content"> <!-- Main Content Section with everything -->
                    ...
                    <?php
                        ...
                        if($form_valide){
                            ...
                            // Si on ajoute l'offre
                            if($_POST["action"] == "add"){
                            // on crée la requête SQL 
                                $sql = 'INSERT INTO stage (date_deb, date_fin, mail_contact, num_contact, theme, id_etab, resume, statut)
                                        VALUES ("'  .$date_deb . '","'
                                                  . $date_fin . '","'
                                                  . $mail_contact . '","'
                                                  . $num_contact . '","'
                           ...
                           if($result)
                           {
                                ...
                                <?php
                                header( "refresh:2;url=offres_stage.php" );
                           }
                           else
                           {
                               die("Erreur SQL");
